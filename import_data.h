...
struct attraction {
    ...
    std::map<int, int> wait_time_sinlge_rider = {};
    int single_rider = -1;
...
struct setting {
    ...
    std::vector<int> full_ID_list = { 8, 9, 5, 4, 2707, 7, 6, 19, 22, 15, 20, 23, 14, 16, 18, 17, 21, 3, 2, 1, 25, 26, 28, 24, 13, 4573, 29, 37, 32, 35, 34, 36, 31, 10848, 10845, 33, 40 };// excluding Single Rider
    std::vector<int> ID_list = { 8, 9, 5, 4, 2707, 7, 6, 19, 22, 15, 20, 23, 14, 16, 18, 17, 21, 3, 2, 1, 25, 26, 28, 24, 13, 4573, 29, 37, 32, 35, 34, 36, 31, 10848, 10845, 33, 40 };
    std::vector<int> single_rider_list = { 7277,7278,7279,7280,7281,7306,10846,10849 };
